...
setup-%CPU% --no-admin --root %CYGWIN_BASE% --quiet-mode --no-shortcuts --site http://cygwin.mirror.constant.com/ --categories Base -l %CYGWIN_BASE%\var\cache\apt\packages --packages dos2unix,ncurses,wget,make,vim,ed,flex,bison,nasm,curl,unzip
